...
```
Builds signed source packages for each Ubuntu release (questing, plucky, noble,
...
| `LAUNCHPAD_RELEASES` | `questing plucky noble jammy` | Space-separated Ubuntu releases for PPA |
