...
class TestAuthLogin:
    ...
    def test_login_rate_limited(self, client, mock_login_security):
        ...
        response = client.post(
            "/api/v1/login",
            json={"userid": "test@example.com", "password": "password123"},
        )
    ...
    def test_login_invalid_email_format(self, client):
        ...
        response = client.post(
            "/api/v1/login", json={"userid": "invalid-email", "password": "password123"}
        )
    ...
    def test_login_missing_fields(self, client):
        ...
        # Missing password
        response = client.post("/api/v1/login", json={"userid": "test@example.com"})
