...
class TestPackagesAPI:
    ...
    def test_get_packages_summary_success(self, client, auth_headers, sample_packages):
        ...
        response = client.get("/api/v1/packages/summary", headers=auth_headers)
    ...
    def test_get_package_managers_success(self, client, auth_headers, sample_packages):
        ...
        response = client.get("/api/v1/packages/managers", headers=auth_headers)
    ...
    def test_get_package_managers_with_os_filter(
        ...
        response = client.get(
            "/api/v1/packages/managers?os_name=Ubuntu", headers=auth_headers
        )
    ...
    def test_get_package_managers_with_version_filter(
        ...
        response = client.get(
            "/api/v1/packages/managers?os_name=Ubuntu&os_version=22.04",
    ...
    def test_search_packages_success(self, client, auth_headers, sample_packages):
        ...
        response = client.get(
            "/api/v1/packages/search?query=nginx", headers=auth_headers
        )
    ...
    def test_search_packages_multiple_results(
        ...
        response = client.get(
            "/api/v1/packages/search?query=python", headers=auth_headers
        )
    ...
    def test_search_packages_with_os_filter(
        ...
        response = client.get(
            "/api/v1/packages/search?query=http&os_name=CentOS", headers=auth_headers
        )
    ...
    def test_search_packages_with_manager_filter(
        ...
        response = client.get(
            "/api/v1/packages/search?query=docker&package_manager=snap",
            headers=auth_headers,
        )
    ...
    def test_search_packages_with_pagination(
        ...
        response = client.get(
            "/api/v1/packages/search?query=p&limit=2&offset=0", headers=auth_headers
        )
    ...
    def test_search_packages_no_results(self, client, auth_headers, sample_packages):
        ...
        response = client.get(
            "/api/v1/packages/search?query=nonexistent", headers=auth_headers
        )
    ...
    def test_search_packages_missing_query(self, client, auth_headers):
        ...
        response = client.get("/api/v1/packages/search", headers=auth_headers)
    ...
    def test_get_os_versions_success(self, client, auth_headers, sample_packages):
        ...
        response = client.get("/api/v1/packages/os-versions", headers=auth_headers)
    ...
    def test_get_packages_by_manager_success(
        ...
        response = client.get("/api/v1/packages/by-manager/apt", headers=auth_headers)
    ...
    def test_get_packages_by_manager_with_os_filter(
        ...
        response = client.get(
            "/api/v1/packages/by-manager/apt?os_name=Ubuntu&os_version=22.04",
            headers=auth_headers,
        )
    ...
    def test_get_packages_by_manager_nonexistent(
        ...
        response = client.get(
            "/api/v1/packages/by-manager/nonexistent", headers=auth_headers
        )
    ...
    def test_get_packages_by_manager_with_pagination(
        ...
        response = client.get(
            "/api/v1/packages/by-manager/apt?limit=1&offset=0", headers=auth_headers
        )
    ...
    def test_search_packages_invalid_pagination(self, client, auth_headers):
        ...
        response = client.get(
            "/api/v1/packages/search?query=nginx&offset=-1", headers=auth_headers
        )
        assert response.status_code == 422

        # Test zero limit
        response = client.get(
            "/api/v1/packages/search?query=nginx&limit=0", headers=auth_headers
        )
        assert response.status_code == 422

        # Test limit too high
        response = client.get(
            "/api/v1/packages/search?query=nginx&limit=1001", headers=auth_headers
        )
        assert response.status_code == 422
    ...
    def test_packages_api_comprehensive_workflow(
        ...
        # 1. Get summary
        summary_response = client.get("/api/v1/packages/summary", headers=auth_headers)
        assert summary_response.status_code == 200

        # 2. Get available managers
        managers_response = client.get(
            "/api/v1/packages/managers", headers=auth_headers
        )
        ...
        by_manager_response = client.get(
            "/api/v1/packages/by-manager/apt", headers=auth_headers
        )
        assert by_manager_response.status_code == 200

        # 5. Get OS versions
        os_versions_response = client.get(
            "/api/v1/packages/os-versions", headers=auth_headers
        )
    ...
    def test_unauthorized_requests_fail_properly(self):
        ...
        try:
            with TestClient(app) as test_client:
                response = test_client.get("/api/v1/packages/summary")
