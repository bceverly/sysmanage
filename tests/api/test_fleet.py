...
class TestFleetStatus:
    ...
    def test_get_fleet_status_success(
        ...
        response = client.get("/fleet/status", headers=auth_headers)
...
class TestListAgents:
    ...
    def test_list_agents_success(self, mock_connection_manager, client, auth_headers):
        ...
        response = client.get("/fleet/agents", headers=auth_headers)
...
class TestGetAgent:
    ...
    def test_get_agent_success(self, mock_connection_manager, client, auth_headers):
        ...
        response = client.get("/fleet/agent/test.example.com", headers=auth_headers)
    ...
    def test_get_agent_not_found(self, mock_connection_manager, client, auth_headers):
        ...
        response = client.get(
            "/fleet/agent/nonexistent.example.com", headers=auth_headers
        )
    ...
    def test_get_agent_unauthorized(self, client):
        ...
        response = client.get("/fleet/agent/test.example.com")
        assert response.status_code == 403
...
class TestSendCommand:
    ...
    def test_send_command_success(self, mock_connection_manager, client, auth_headers):
        ...
        response = client.post(
            "/fleet/agent/test.example.com/command",
            json=command_data,
    ...
    def test_send_command_agent_not_connected(
        ...
        response = client.post(
            "/fleet/agent/offline.example.com/command",
            json=command_data,
            headers=auth_headers,
        )
    ...
    def test_send_command_unauthorized(self, client):
        ...
        response = client.post(
            "/fleet/agent/test.example.com/command", json=command_data
        )
        assert response.status_code == 403
...
class TestShellCommand:
    ...
    def test_send_shell_command_success(
        ...
        response = client.post(
            "/fleet/agent/test.example.com/shell",
            json=shell_data,
            headers=auth_headers,
        )
    ...
    def test_send_shell_command_agent_not_found(
        ...
        response = client.post(
            "/fleet/agent/nonexistent.example.com/shell",
            json=shell_data,
            headers=auth_headers,
        )
    ...
    def test_send_shell_command_unauthorized(self, client):
        ...
        response = client.post("/fleet/agent/test.example.com/shell", json=shell_data)
        assert response.status_code == 403
...
class TestPackageManagement:
    ...
    def test_install_package_success(
        ...
        response = client.post(
            "/fleet/agent/test.example.com/install-package",
            json=package_data,
            headers=auth_headers,
        )
...
class TestServiceManagement:
    ...
    def test_restart_service_success(
        ...
        response = client.post(
            "/fleet/agent/test.example.com/restart-service",
            json=service_data,
            headers=auth_headers,
        )
...
class TestSystemCommands:
    ...
    def test_update_system_success(self, mock_connection_manager, client, auth_headers):
        ...
        response = client.post(
            "/fleet/agent/test.example.com/update-system",
            json={},
            headers=auth_headers,
        )
    ...
    def test_reboot_system_success(self, mock_connection_manager, client, auth_headers):
        ...
        response = client.post(
            "/fleet/agent/test.example.com/reboot", json={}, headers=auth_headers
        )
...
class TestBroadcastCommand:
    ...
    def test_broadcast_command_success(
        ...
        response = client.post(
            "/fleet/broadcast/command", json=broadcast_data, headers=auth_headers
        )
    ...
    def test_broadcast_command_unauthorized(self, client):
        ...
        response = client.post("/fleet/broadcast/command", json=broadcast_data)
        assert response.status_code == 403
