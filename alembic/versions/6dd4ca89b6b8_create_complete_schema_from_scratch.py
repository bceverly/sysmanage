...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "profile_image_uploaded_at", sa.DateTime(timezone=True), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "diagnostics_requested_at", sa.DateTime(timezone=True), nullable=True
        ),
        sa.Column("diagnostics_request_status", sa.String(length=50), nullable=True),
        # Update management fields
        sa.Column(
            "reboot_required", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column(
            "reboot_required_updated_at", sa.DateTime(timezone=True), nullable=True
        ),
        # Agent privilege status
        sa.Column(
            "is_agent_privileged", sa.Boolean(), nullable=True, server_default="false"
        ),
    ...
    op.create_index(
        "ix_host_certificates_file_path", "host_certificates", ["file_path"]
    )
    op.create_index(
        "ix_host_certificates_not_after", "host_certificates", ["not_after"]
    )
    op.create_index(
        "ix_host_certificates_fingerprint_sha256",
        "host_certificates",
        ["fingerprint_sha256"],
    )
    op.create_index(
        "ix_host_certificates_collected_at", "host_certificates", ["collected_at"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "is_system_package", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(["host_id"], ["host.id"], ondelete="CASCADE"),
    ...
    op.create_index(
        "ix_software_package_package_name", "software_package", ["package_name"]
    )
    ...
    op.create_table(
        ...
        sa.Column("size_bytes", sa.BigInteger(), nullable=True),
        sa.Column(
            "requires_reboot", sa.Boolean(), nullable=False, server_default="false"
        ),
    ...
    op.create_index(
        "ix_package_update_package_name", "package_update", ["package_name"]
    )
    ...
    op.create_index(
        "ix_available_packages_package_name", "available_packages", ["package_name"]
    )
    op.create_index(
        "ix_available_packages_package_manager",
        "available_packages",
        ["package_manager"],
    )
    op.create_index("ix_available_packages_os_name", "available_packages", ["os_name"])
    op.create_index(
        "ix_available_packages_os_version", "available_packages", ["os_version"]
    )
    ...
    op.create_index(
        "ix_software_installation_log_status", "software_installation_log", ["status"]
    )
    op.create_index(
        "ix_software_installation_log_requested_at",
        "software_installation_log",
        ["requested_at"],
    )
    ...
    op.create_index(
        "ix_installation_requests_requested_at",
        "installation_requests",
        ["requested_at"],
    )
    op.create_index(
        "ix_installation_requests_status", "installation_requests", ["status"]
    )
    op.create_index(
        "ix_installation_requests_operation_type",
        "installation_requests",
        ["operation_type"],
    )
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column(
            "installation_request_id", postgresql.UUID(as_uuid=True), nullable=False
        ),
        sa.Column("package_name", sa.String(length=255), nullable=False),
        sa.Column("package_manager", sa.String(length=50), nullable=False),
    ...
    op.create_index(
        "ix_installation_packages_installation_request_id",
        "installation_packages",
        ["installation_request_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "is_system_user", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(["host_id"], ["host.id"], ondelete="CASCADE"),
    ...
    op.create_table(
        ...
        sa.Column(
            "is_system_group", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(["host_id"], ["host.id"], ondelete="CASCADE"),
    ...
    op.create_table(
        ...
        sa.Column(
            "reboot_requested", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(["host_id"], ["host.id"], ondelete="CASCADE"),
    ...
    op.create_index(
        "ix_update_execution_log_package_name", "update_execution_log", ["package_name"]
    )
    ...
    op.create_index(
        "ix_message_queue_correlation_id", "message_queue", ["correlation_id"]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["host_id"], ["host.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["saved_script_id"], ["saved_scripts.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "ix_script_execution_log_execution_id", "script_execution_log", ["execution_id"]
    )
    op.create_index(
        "ix_script_execution_log_execution_uuid",
        "script_execution_log",
        ["execution_uuid"],
    )
    ...
    op.create_index(
        "ix_diagnostic_report_collection_id", "diagnostic_report", ["collection_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column(
            "host_id", postgresql.UUID(as_uuid=True), nullable=False, unique=True
        ),
    ...
    op.create_table(
        ...
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(
            ["ubuntu_pro_info_id"], ["ubuntu_pro_info.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "auto_attach_enabled", sa.Boolean(), nullable=False, server_default="false"
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), nullable=False),
        sa.PrimaryKeyConstraint("id"),
