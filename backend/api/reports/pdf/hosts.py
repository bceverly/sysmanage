...
class HostsReportGenerator(ReportGenerator):
    ...
    def generate_firewall_status_report(self) -> io.BytesIO:
    ...
    def generate_antivirus_opensource_report(self) -> io.BytesIO:
    ...
    def generate_antivirus_commercial_report(self) -> io.BytesIO:
