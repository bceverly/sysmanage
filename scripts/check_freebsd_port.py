...
Shared with the sysmanage-agent repo, which has the same skeleton and had the
same defects; keep the two copies in step.
...
PORT_DIR = Path("packaging/freebsd-ports/sysutils/sysmanage")
